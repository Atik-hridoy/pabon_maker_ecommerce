      ...
      <div className="max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop">
        <div className="flex justify-between items-end mb-12">
          ...
          <div className="flex gap-2">
            <button className="w-10 h-10 border border-outline-variant flex items-center justify-center rounded hover:border-secondary transition-colors">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-gutter">
          ...
          <div className="product-card-hover group border border-outline-variant p-6 transition-all bg-white relative">
            ...
            <div className="aspect-square mb-6 overflow-hidden flex items-center justify-center p-4">
              <img className="w-full h-full object-contain group-hover:scale-105 transition-transform duration-500" alt="MK-Ultra 32-bit SoC Dev Board" src="https://lh3.googleusercontent.com/aida-public/AB6AXuBviCHEDJ3V0nHRlAPoLNQJpHicu0X5hPxQYmuTrHqtbF2A0Ek-FL0UoHZxqzK8IeJYjBH6MNGhH62I8nuNuuQynt_ldN_AJ75eHqpLmVT3YiynT0nNYTZVmIjpMesO922vWTYESkZIRfXOje1feq0kdwDkSbcWtmd4--VZ1SW1ftS1rdaPaJv-ZI_zURq6qXWE8_h5B1jQdWhbeSNzBxs76Smdk8L5KCiYKT9kXqD73cmVgQi-DuZb0DZCKfOoza5pk0zwOBckifTG" />
            </div>
          ...
          <div className="product-card-hover group border border-outline-variant p-6 transition-all bg-white relative">
            <div className="aspect-square mb-6 overflow-hidden flex items-center justify-center p-4">
              <img className="w-full h-full object-contain group-hover:scale-105 transition-transform duration-500" alt="Laser-Precision ToF Sensor Module" src="https://lh3.googleusercontent.com/aida-public/AB6AXuDd32I9bq6A7RVh9YWUD0StycQcfKspSBe34SKSEWt1Vxxtgk1mP_WRubPrW5gbLHKzDDv3DFg7LOHoWAnucRD6QMpOAWMdXYYE2IwhKla1s_cFfoQizDmK2JxLGwkFu3JZhPV0C7ow0EwMJ0L4Vje4n12v06LX1t3Tr4jgK_bNhbKGB8mR45VUlQHEqQdDXvbi3enKNzs0dKB1YFGQM1FuF2mIFQhpRCGFtqfrB_UlEWhbibXBSTKMI745hy8o0KL6MwDtIB_qifUP" />
            </div>
            <div className="space-y-2">
              <div className="flex text-secondary-container gap-0.5">
                <span className="material-symbols-outlined text-[14px]" style={{ fontVariationSettings: "'FILL' 1" }}>star</span>
          ...
          <div className="product-card-hover group border border-outline-variant p-6 transition-all bg-white relative">
            ...
            <div className="aspect-square mb-6 overflow-hidden flex items-center justify-center p-4">
              <img className="w-full h-full object-contain group-hover:scale-105 transition-transform duration-500" alt="IoT Connect Pro WiFi/BLE Chip" src="https://lh3.googleusercontent.com/aida-public/AB6AXuAWvwrNFgo6k6IqX5KMcnsUXJWtCJeuDYqvJA4HbfmaWVK5ar0zeHESwsWZU2CeSK0k3p8pikA9VW2uS68NsH6GFjhZ1MMK-S19Y6CwmurxBPTKkmVmcFJYgPAYhyZsQgdd5qGqUpj7pVzlBOIfiD2Pm_QTYc5eD8amRyVwrzErNLADUPSWByz3BqJN4ywbRLCzWaRB4BR5BNK8CbVobA6cGbZPV2g0fJo2lK0r5jAqBVCCLa4zsSot88jt8mY36l22VpgoQJSw_wYD" />
            </div>
            <div className="space-y-2">
              <div className="flex text-secondary-container gap-0.5">
                <span className="material-symbols-outlined text-[14px]" style={{ fontVariationSettings: "'FILL' 1" }}>star</span>
          ...
          <div className="product-card-hover group border border-outline-variant p-6 transition-all bg-white relative">
            <div className="aspect-square mb-6 overflow-hidden flex items-center justify-center p-4">
              <img className="w-full h-full object-contain group-hover:scale-105 transition-transform duration-500" alt="Precision NEMA 17 Stepper Motor" src="https://lh3.googleusercontent.com/aida-public/AB6AXuD-4V5HZhlCgjUjhhjeq3OTIas00jLs8P-WpXGBSl5flOoJ4AeG-tj0_Qf6ZBx7P_xuGtQDWnszeYQop93CXK7uNPd0SSndS5D0MesTrbr4YIa90qz-QEGRPME-WnGohpRi9DIFo8N_rErrCXuRWQZzIOb7c2YavaZip4DoqNf6RjC_jvn-iGBQOrv1uR4QpPTnep_I6khxfmlSzPppVw_mpCANaDIquCxgw8RmFYs0P3OsX28Una3pjT3bi8Wus0RIQ_1rbGsCDQO_" />
            </div>
            <div className="space-y-2">
              <div className="flex text-secondary-container gap-0.5">
                <span className="material-symbols-outlined text-[14px]" style={{ fontVariationSettings: "'FILL' 1" }}>star</span>
