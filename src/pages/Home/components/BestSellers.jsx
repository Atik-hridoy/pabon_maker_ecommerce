    ...
    <section className="py-20 bg-white">
      <div className="max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 xl:grid-cols-6 gap-4">
          {/* Product Card 1 */}
          <div onClick={() => navigate('/product/mc-01')} className="product-card-hover group border border-outline-variant p-4 transition-all bg-white relative block cursor-pointer rounded-lg">
            ...
            <div className="space-y-2">
              ...
              <h3 className="font-bold text-sm text-on-surface line-clamp-2">MK-Ultra 32-bit SoC Dev Board</h3>
              <p className="hidden md:block text-xs text-on-surface-variant line-clamp-1">3.3V - 5V | Dual Core</p>
              <div className="flex items-center justify-between pt-4">
                <span className="font-bold text-on-surface">$24.99</span>
                <button className="hidden md:block bg-surface-container text-on-surface-variant p-1.5 rounded hover:bg-secondary-container hover:text-white transition-colors" onClick={(e) => { e.stopPropagation(); e.preventDefault(); }}>
          ...
          {/* Product Card 2 */}
          <div onClick={() => navigate('/product/sm-01')} className="product-card-hover group border border-outline-variant p-4 transition-all bg-white relative block cursor-pointer rounded-lg">
            <div className="h-32 mb-4 overflow-hidden flex items-center justify-center p-2 bg-surface-container-lowest rounded">
            ...
            <div className="space-y-2">
              ...
              <h3 className="font-bold text-sm text-on-surface line-clamp-2">Laser-Precision ToF Sensor Module</h3>
              <p className="hidden md:block text-xs text-on-surface-variant line-clamp-1">5V DC | 0.1mm Accuracy</p>
              <div className="flex items-center justify-between pt-4">
                <span className="font-bold text-on-surface">$18.50</span>
                <button className="hidden md:block bg-surface-container text-on-surface-variant p-1.5 rounded hover:bg-secondary-container hover:text-white transition-colors" onClick={(e) => { e.stopPropagation(); e.preventDefault(); }}>
                  <span className="material-symbols-outlined text-[18px]">shopping_cart</span>
                </button>
              </div>
          ...
          {/* Product Card 3 */}
          <div onClick={() => navigate('/product/iot-01')} className="product-card-hover group border border-outline-variant p-4 transition-all bg-white relative block cursor-pointer rounded-lg">
            <div className="absolute top-4 left-4 z-10">
            ...
            <div className="space-y-2">
              ...
              <h3 className="font-bold text-sm text-on-surface line-clamp-2">IoT Connect Pro WiFi/BLE Chip</h3>
              <p className="hidden md:block text-xs text-on-surface-variant line-clamp-1">Ultra Low Power | 2.4GHz</p>
              <div className="flex items-center justify-between pt-4">
                <div className="flex flex-col">
                  <span className="text-outline line-through text-xs">$12.00</span>
                  <span className="font-bold text-secondary">$7.99</span>
                </div>
                <button className="hidden md:block bg-surface-container text-on-surface-variant p-1.5 rounded hover:bg-secondary-container hover:text-white transition-colors" onClick={(e) => { e.stopPropagation(); e.preventDefault(); }}>
                  <span className="material-symbols-outlined text-[18px]">shopping_cart</span>
                </button>
          ...
          {/* Product Card 4 */}
          <div onClick={() => navigate('/product/ra-01')} className="product-card-hover group border border-outline-variant p-4 transition-all bg-white relative block cursor-pointer rounded-lg">
            <div className="h-32 mb-4 overflow-hidden flex items-center justify-center p-2 bg-surface-container-lowest rounded">
            ...
            <div className="space-y-2">
              ...
              <h3 className="font-bold text-sm text-on-surface line-clamp-2">Precision NEMA 17 Stepper Motor</h3>
              <p className="hidden md:block text-xs text-on-surface-variant line-clamp-1">1.8° Step | 12-24V DC</p>
              <div className="flex items-center justify-between pt-4">
                <span className="font-bold text-on-surface">$32.00</span>
                <button className="hidden md:block bg-surface-container text-on-surface-variant p-1.5 rounded hover:bg-secondary-container hover:text-white transition-colors" onClick={(e) => { e.stopPropagation(); e.preventDefault(); }}>
                  <span className="material-symbols-outlined text-[18px]">shopping_cart</span>
                </button>
              </div>
