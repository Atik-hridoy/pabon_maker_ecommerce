        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-5 xl:grid-cols-6 gap-4">
          ...
          <div onClick={() => navigate('/product/mc-01')} className="product-card-hover group border border-outline-variant p-4 transition-all bg-white relative block cursor-pointer rounded-lg">
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-on-surface-variant line-clamp-1">3.3V - 5V | Dual Core</p>
              <div className="flex items-center justify-between pt-4">
                <span className="font-bold text-on-surface">$24.99</span>
                <button className="bg-surface-container text-on-surface-variant p-1.5 rounded hover:bg-secondary-container hover:text-white transition-colors" onClick={(e) => { e.stopPropagation(); e.preventDefault(); }}>
          ...
          <div onClick={() => navigate('/product/sm-01')} className="product-card-hover group border border-outline-variant p-4 transition-all bg-white relative block cursor-pointer rounded-lg">
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-on-surface-variant line-clamp-1">5V DC | 0.1mm Accuracy</p>
              <div className="flex items-center justify-between pt-4">
          ...
          <div onClick={() => navigate('/product/iot-01')} className="product-card-hover group border border-outline-variant p-4 transition-all bg-white relative block cursor-pointer rounded-lg">
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-on-surface-variant line-clamp-1">Ultra Low Power | 2.4GHz</p>
              <div className="flex items-center justify-between pt-4">
          ...
          <div onClick={() => navigate('/product/ra-01')} className="product-card-hover group border border-outline-variant p-4 transition-all bg-white relative block cursor-pointer rounded-lg">
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-on-surface-variant line-clamp-1">1.8° Step | 12-24V DC</p>
              <div className="flex items-center justify-between pt-4">
