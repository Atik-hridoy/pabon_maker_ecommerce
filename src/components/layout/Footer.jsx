    ...
    <footer className="bg-primary-container dark:bg-black" id="contact">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-gutter px-margin-mobile md:px-margin-desktop py-stack-lg max-w-container-max mx-auto">
        ...
        <div className="space-y-4">
          ...
          <ul className="space-y-2">
            <li><a className="text-on-primary-container dark:text-surface-variant hover:text-secondary-container transition-colors font-body-sm text-body-sm" href="#">Microcontrollers</a></li>
            <li><a className="text-on-primary-container dark:text-surface-variant hover:text-secondary-container transition-colors font-body-sm text-body-sm" href="#">Sensors</a></li>
            <li><a className="text-on-primary-container dark:text-surface-variant hover:text-secondary-container transition-colors font-body-sm text-body-sm" href="#">Robotics</a></li>
            <li><a className="text-on-primary-container dark:text-surface-variant hover:text-secondary-container transition-colors font-body-sm text-body-sm" href="#">Sale Items</a></li>
          </ul>
        </div>
        ...
        <div className="space-y-4">
          ...
          <ul className="space-y-2">
            <li><a className="text-on-primary-container dark:text-surface-variant hover:text-secondary-container transition-colors font-body-sm text-body-sm" href="#">Datasheets</a></li>
            <li><a className="text-on-primary-container dark:text-surface-variant hover:text-secondary-container transition-colors font-body-sm text-body-sm" href="#">Shipping Policy</a></li>
            <li><a className="text-on-primary-container dark:text-surface-variant hover:text-secondary-container transition-colors font-body-sm text-body-sm" href="#">Expert Consultation</a></li>
            <li><a className="text-on-primary-container dark:text-surface-variant hover:text-secondary-container transition-colors font-body-sm text-body-sm" href="#">Help Center</a></li>
          </ul>
        </div>
      </div>
      ...
      <div className="px-margin-mobile md:px-margin-desktop max-w-container-max mx-auto mb-12">
        <div className="max-w-md space-y-4">
          ...
          <form className="flex">
            <input className="bg-surface-container-low/10 border border-outline text-white px-4 py-2 w-full focus:ring-1 focus:ring-secondary-container outline-none text-sm" placeholder="Email Address" type="email" />
